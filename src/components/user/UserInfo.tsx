...
type Props = {
  ...
  //CheckAndReturnActiveToFormerState: (userId: number) => void;
};
const UserInfo = ({
  users,
  isLoading,
  ...
  //CheckAndReturnActiveToFormerState,
}: Props) => {
  //const [data, setData] = useState<any[]>([]); // for user list tree
  ...
  return (
    <div className="w-full md:w-1/2 md:h-full flex flex-col items-start justify-start md:justify-between md:items-center  gap-2 py-2 text-gray-600">
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-2">
        <Input
          label="جستجو:"
          placeholder="جستجو..."
          widthDiv={width > 640 ? "w-1/4" : "w-full"}
          widthInput="w-full"
