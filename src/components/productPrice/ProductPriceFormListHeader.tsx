...
const ProductPriceFormListHeader = ({
  columns,
  brandSearch,
  setBrandSearch,
  productSearch,
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="md:h-full border border-x-gray-300 bg-gray-200 place-content-center text-center"
...
export default ProductPriceFormListHeader;
